---
id: PORTAL-DIRECTIVES-001
aliases: ["DIRECTIVES", "Directives Portal", "System Directives", "Modular Directives"]
tags: ["governance", "directives", "rules", "constitution", "policy"]
status: ACTIVE
updated: 2026-09-06
---
...
```mermaid
graph TD
    Const["Level 1: Sovereign Constitution<br/>[[00-CONSTITUTION]]"] --> Master["Level 2: Universal Operating Contract<br/>[[ANTIGRAVITY]] (45 Rules)"]
    Master --> AgentDirectives["Level 3: Modular Agent Directives<br/>[[AGENTS]] & .agents/rules/"]
    Master --> TacticalDirectives["Level 4: Tactical Operating Directives<br/>[[PRIORITIES]] & [[STOP-DOING]]"]
    Master --> PolicyDirectives["Level 5: Domain Policies<br/>[[21-POLICY]] & [[INFRASTRUCTURE-POLICY]]"]
```
