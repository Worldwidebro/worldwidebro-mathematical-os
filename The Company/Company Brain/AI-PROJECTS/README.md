---
id: PORTAL-AI-PROJECTS-001
aliases: ["AI-PROJECTS", "AI Projects", "Autonomous Ventures", "AI Portfolio"]
tags: ["projects", "ventures", "repositories", "capabilities", "portfolio"]
status: ACTIVE
updated: 2026-09-06
---
...
```mermaid
graph TD
    Ventures["722 Canonical Ventures<br/>[[23-VENTURES]]"] --> CoreOpCos["7 Core Operating Companies<br/>(LegalTech, Logistics, FinTech, Media, MedTech, Construction, Cyber)"]
    CoreOpCos --> CodeRepos["177 Verified Code Repositories<br/>[[13-REPOSITORIES]]"]
    CodeRepos --> Capabilities["284 Capability Solutions<br/>[[14-CAPABILITIES]]"]
    CoreOpCos --> Commercial["Active Commercial Offers<br/>[[COMMERCIAL/OFFERS/OFFER-001-LOCAL-AI-AUDIT]]"]
```
