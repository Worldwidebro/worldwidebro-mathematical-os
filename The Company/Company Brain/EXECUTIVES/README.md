---
id: PORTAL-EXECUTIVES-001
aliases: ["EXECUTIVES", "Executive Hub", "Executive Governance Portal", "C-Suite"]
tags: ["governance", "executives", "leadership", "c-suite", "truth-ledger"]
status: ACTIVE
updated: 2026-09-06
---
...
```mermaid
graph TD
    Sovereign["Sovereign Operator<br/>(Supreme Capital & Architectural Authority)"] --> Reality["Executive Truth Ledger<br/>[[REALITY]] & [[ECONOMIC-REALITY]]"]
    Reality --> CoreOpCos["7 Core Operating Ventures<br/>[[23-VENTURES]]"]
    Reality --> DecisionGate["Governance & Decision Gate<br/>[[46-GOVERNANCE]] & [[20-DECISIONS]]"]
    Reality --> DirectivesHub["Directives & Mandates<br/>[[DIRECTIVES]] & [[PRIORITIES]]"]
```
