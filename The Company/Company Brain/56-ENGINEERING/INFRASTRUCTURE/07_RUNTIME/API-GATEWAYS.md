...
tags: ['runtime', 'api-gateways', 'infrastructure']
status: ACTIVE
updated: 2026-09-06
---
...
# API Gateways: OmniRoute & LiteLLM

> **Authority:** CP-027 | **Status:** LIVE_VERIFIED

- **OmniRoute (`:20128`):** Distributed gateway and MCP Hub.
- **LiteLLM (`:4000`):** OpenAI-compatible model router with provider abstraction and fallback logic.
