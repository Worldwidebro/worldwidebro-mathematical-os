...
tags: ['deployment', 'container-registry', 'infrastructure']
status: ACTIVE
updated: 2026-09-06
---
...
# Container Registry (ghcr.io & Local)

> **Authority:** CP-027 | **Status:** ACTIVE

- Images pulled from GitHub Container Registry (`ghcr.io`) and cached on Mac Studio.
