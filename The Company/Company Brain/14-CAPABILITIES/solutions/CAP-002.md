...
status: ACTIVE
updated: 2026-09-06
tags: ['auth', 'oauth2', 'oidc', 'jwt', 'passkeys']
---
...
## 2. Problem Statement
Ventures operating without `CAP-002` typically encounter:
- Vulnerability to credential stuffing, replay attacks, and session hijacking
- Poor user experience across federated services
- Difficulty enforcing session lifecycle and revocation
...
1. **Assess**: Evaluate current venture state, data contracts, and technical debt against `CAP-002` requirements.
