...
```mermaid
flowchart TD
    subgraph OwnershipLayers["Estate & Governance Hierarchy"]
        L1["Layer 1: FOUNDER / FAMILY OWNERSHIP (ENT-001 to 015)"]
        L2["Layer 2: ESTATE & SUCCESSION PLANNING (ENT-016 to 030)"]
        L3["Layer 3: MASTER HOLDING STRUCTURE (ENT-031 to 045)"]
    end

    subgraph OperatingLayers["Operating Company Segregation"]
        L4["Layer 4: OPERATING COMPANY LAYER (ENT-046 to 065)"]
        L5["Layer 5: LOGISTICS & DISPATCH (ENT-066 to 080)"]
        L6["Layer 6: HEALTHCARE & MEDICAL COURIER (ENT-081 to 090)"]
        L7["Layer 7: REAL ESTATE EMPIRE (ENT-091 to 110)"]
        L8["Layer 8: CONSTRUCTION & FIELD SERVICES (ENT-111 to 118)"]
    end

    subgraph PlatformLayers["Capital, Tech & Fiduciary Enclosure"]
        L9["Layer 9: TECHNOLOGY, IP & COMPANY BRAIN (ENT-119 to 130)"]
        L10["Layer 10: CAPITAL MARKETS & TRADING (ENT-131 to 138)"]
        L11["Layer 11: PHILANTHROPY & FOUNDATION (ENT-139 to 144)"]
        L12["Layer 12: ADVISORY & FIDUCIARY NETWORK (ENT-145 to 150)"]
    end

    OwnershipLayers --> OperatingLayers
    OwnershipLayers --> PlatformLayers
```
