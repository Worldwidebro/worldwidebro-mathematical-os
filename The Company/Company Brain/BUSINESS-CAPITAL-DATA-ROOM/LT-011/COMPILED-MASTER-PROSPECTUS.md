...
- **KPI:** Onboarding completion rate ≥90% (of signups)
...
- **Objective:** Refine trial-to-paid conversion from <20% to ≥30%
- **Actions:**
  - Close 20-30 trials
...
### Capital Milestones
1. **Deployment & Onboarding** (✅ Sept 15): App live; carriers can sign up and access demo
2. **Proof of Model** (✅ Oct 31): 30 trials; 10 paid; trial-to-paid ≥30%; $500+ MRR
3. **Repeatable Sales** (✅ Nov 30): 50+ trials; 25+ paid customers; CAC <$100; LTV >$700
4. **Expansion Revenue** (✅ Dec 31): Upsell funnel active; 180+ subs; $10K+ MRR; NRR ≥110%
5. **Growth Capital Ready** (✅ Jan 31): $12K+ MRR; playbook documented; predictable churn <3%
...
- 🎯 **Month 3:** 120-180 customers + $10K MRR + NRR ≥110% = **READY FOR GROWTH CAPITAL**
...
**NAICS Code:** 488510 (Freight Transportation Arrangement) / 541511  
**Live Platform:** [https://lt-011-dispatch-software.vercel.app](https://lt-011-dispatch-software.vercel.app)  
...
brand_name: "CarrierDispatch / DispatchOS"
requested_amount: "$500,000 SBA Express Facility + $500,000 Factoring Line"
date: "2026-09-07"
```
...
Production Web Surface: https://lt-011-dispatch-software.vercel.app
Repository: `Worldwidebro/lt-011-dispatch-software` (Commit `3ec3011`)
...
# 🏛️ Grant Proposal Package: WorldwideBro Fleet OS LLC (CarrierDispatch)
...
program: "DOT SBIR Phase I — Advanced Freight Operations & Emissions Mitigation"
solicitation_number: "DOT-SBIR-26-01"
grant_request: "$175,000 (Phase I)"
duration: "6 Months"
project_title: "Automated VRP Routing and Corridor Load-Chaining for Small Fleet Deadhead Reduction"
```
...
WorldwideBro Fleet OS LLC is developing an automated **Corridor Load-Chaining & Deadhead Minimization Engine** embedded into CarrierDispatch. By dynamically solving the multi-constraint Vehicle Routing Problem (VRP) across independent owner-operators, this project aims to cut deadhead empty-miles by $\ge 18\%$ along critical interstate freight corridors.
...
$$\text{DSCR} = \frac{\text{Net Operating Income (EBITDA)}}{\text{Annual Debt Service}} = \frac{\$138,000}{\$69,800} = \mathbf{1.98\times} \quad (\text{Minimum Target} \ge 1.25\times)$$
...
use_of_capital: "Carrier acquisition funnels, load-board integrations, embedded fintech expansion"
target_exit: "Series A Institutional Growth / Strategic Acquisition by Logistics Conglomerate"
```
...
Codebase: `Worldwidebro/lt-011-dispatch-software` (Commit: `3ec3011`)
Surface: https://lt-011-dispatch-software.vercel.app
...
| **3. Revenue Evidence & Pipeline** | **88%** | Verified | \$707K signed LOI pipeline (`LOI-LT011-001`, `LOI-LT011-002`); active Stripe checkout live. |
