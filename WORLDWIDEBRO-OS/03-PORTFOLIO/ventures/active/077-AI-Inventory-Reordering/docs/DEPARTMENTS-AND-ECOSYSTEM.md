...
# Departments & System Ecosystem — Ai Inventory Reordering
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: EC-077-AI-Inventory-Reordering)` to implementing code repositories.
