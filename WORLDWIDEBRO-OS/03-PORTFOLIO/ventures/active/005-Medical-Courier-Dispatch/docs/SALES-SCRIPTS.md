...
references:
  - [[LT-005-Medical-Courier-Dispatch-CAPABILITY-STATEMENT]]
  - [[LT-005-Medical-Courier-Dispatch-FORMATION-CREDENTIAL-TRACKER]]
  - [[LT-005-Medical-Courier-Dispatch-AGENT-COMMUNICATION]]
  - [[LOOP-FRAMEWORK]]
---
...
> "Hi [Name], this is [Rep Name] with Medical Courier Dispatch. I'm calling because we work with local carriers and owner-operators running out of the Charlotte region to find higher-paying loads and eliminate empty backhauls. I'm not selling load board subscriptions—we actually run an automated dispatch bot that tracks load rates daily. We put together a list of the 3 highest-paying freight lanes leaving NC this week. Can I text or email that lane list to you?"
...
>
> Best,
> [Rep Name] · Medical Courier Dispatch
