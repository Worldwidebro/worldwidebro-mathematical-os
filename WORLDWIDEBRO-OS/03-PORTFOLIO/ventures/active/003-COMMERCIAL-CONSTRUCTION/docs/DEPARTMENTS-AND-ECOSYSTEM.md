...
# Departments & System Ecosystem — Commercial Construction
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: CON-003-COMMERCIAL-CONSTRUCTION)` to implementing code repositories.
