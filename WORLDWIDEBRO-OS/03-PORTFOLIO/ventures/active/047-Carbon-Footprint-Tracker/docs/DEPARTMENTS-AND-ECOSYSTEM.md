...
# Departments & System Ecosystem — Carbon Footprint Tracker
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: EC-047-Carbon-Footprint-Tracker)` to implementing code repositories.
