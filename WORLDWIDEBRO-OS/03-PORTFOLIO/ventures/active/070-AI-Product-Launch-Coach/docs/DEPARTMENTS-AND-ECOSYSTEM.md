...
# Departments & System Ecosystem — Ai Product Launch Coach
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: EC-070-AI-Product-Launch-Coach)` to implementing code repositories.
