...
# Departments & System Ecosystem — Logistics Dispatch Service
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: LT-003-Logistics-Dispatch-Service)` to implementing code repositories.
