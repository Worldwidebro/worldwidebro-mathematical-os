...
# Departments & System Ecosystem — Freight Ai Optimization
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: LT-028-Freight-AI-Optimization)` to implementing code repositories.
