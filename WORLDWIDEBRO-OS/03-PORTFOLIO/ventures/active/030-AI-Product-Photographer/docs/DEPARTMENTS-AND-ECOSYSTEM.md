...
# Departments & System Ecosystem — Ai Product Photographer
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: EC-030-AI-Product-Photographer)` to implementing code repositories.
