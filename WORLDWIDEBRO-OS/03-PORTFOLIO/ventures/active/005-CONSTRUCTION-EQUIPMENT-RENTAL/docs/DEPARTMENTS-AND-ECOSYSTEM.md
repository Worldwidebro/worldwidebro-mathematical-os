...
# Departments & System Ecosystem — Construction Equipment Rental
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: CON-005-CONSTRUCTION-EQUIPMENT-RENTAL)` to implementing code repositories.
