...
# Departments & System Ecosystem — Credit Repair Automation
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: FIN-002-Credit-Repair-Automation)` to implementing code repositories.
