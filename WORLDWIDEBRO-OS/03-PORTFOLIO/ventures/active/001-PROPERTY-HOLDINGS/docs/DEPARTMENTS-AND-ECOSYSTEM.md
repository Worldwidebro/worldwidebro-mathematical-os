...
references:
  - [[RE-001-PROPERTY-HOLDINGS-AGENT-COMMUNICATION]]
  - [[RE-001-PROPERTY-HOLDINGS-FORMATION-CREDENTIAL-TRACKER]]
  - [[SECTOR-REGISTRY]]
---

# Departments & System Ecosystem — Property Holdings
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: RE-001-PROPERTY-HOLDINGS)` to implementing code repositories.
