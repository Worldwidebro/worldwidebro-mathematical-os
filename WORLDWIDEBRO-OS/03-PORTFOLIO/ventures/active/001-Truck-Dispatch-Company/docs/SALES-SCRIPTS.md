...
references:
  - [[LT-001-Truck-Dispatch-Company-CAPABILITY-STATEMENT]]
  - [[LT-001-Truck-Dispatch-Company-FORMATION-CREDENTIAL-TRACKER]]
  - [[LT-001-Truck-Dispatch-Company-AGENT-COMMUNICATION]]
  - [[LOOP-FRAMEWORK]]
---
...
> "Hi [Name], this is [Rep Name] with Truck Dispatch Company. I'm calling because we work with local carriers and owner-operators running out of the Charlotte region to find higher-paying loads and eliminate empty backhauls. I'm not selling load board subscriptions—we actually run an automated dispatch bot that tracks load rates daily. We put together a list of the 3 highest-paying freight lanes leaving NC this week. Can I text or email that lane list to you?"
...
>
> Best,
> [Rep Name] · Truck Dispatch Company
