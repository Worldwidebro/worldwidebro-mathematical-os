...
# Departments & System Ecosystem — Financial Compliance Scanner
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: FIN-026-Financial-Compliance-Scanner)` to implementing code repositories.
