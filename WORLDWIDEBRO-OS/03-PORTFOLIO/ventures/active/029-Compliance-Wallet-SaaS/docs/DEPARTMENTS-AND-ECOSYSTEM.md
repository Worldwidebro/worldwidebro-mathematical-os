...
# Departments & System Ecosystem — Compliance Wallet Saas
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: FIN-029-Compliance-Wallet-SaaS)` to implementing code repositories.
