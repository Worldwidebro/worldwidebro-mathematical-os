...
# Departments & System Ecosystem — Business Formation Services
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: FIN-008-Business-Formation-Services)` to implementing code repositories.
