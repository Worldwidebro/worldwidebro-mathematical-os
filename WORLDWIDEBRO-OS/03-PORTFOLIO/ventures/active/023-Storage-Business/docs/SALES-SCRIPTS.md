...
references:
  - [[LT-023-Storage-Business-CAPABILITY-STATEMENT]]
  - [[LT-023-Storage-Business-FORMATION-CREDENTIAL-TRACKER]]
  - [[LT-023-Storage-Business-AGENT-COMMUNICATION]]
  - [[LOOP-FRAMEWORK]]
---
...
> "Hi [Name], this is [Rep Name] with Storage Business. I'm calling because we work with local carriers and owner-operators running out of the Charlotte region to find higher-paying loads and eliminate empty backhauls. I'm not selling load board subscriptions—we actually run an automated dispatch bot that tracks load rates daily. We put together a list of the 3 highest-paying freight lanes leaving NC this week. Can I text or email that lane list to you?"
