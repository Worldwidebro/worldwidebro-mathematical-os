...
references:
  - [[EC-021-Luggage-AI-AGENT-COMMUNICATION]]
  - [[EC-021-Luggage-AI-FORMATION-CREDENTIAL-TRACKER]]
  - [[SECTOR-REGISTRY]]
---

# Departments & System Ecosystem — Luggage Ai
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: EC-021-Luggage-AI)` to implementing code repositories.
