...
# Departments & System Ecosystem — Residential Construction
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: CON-002-RESIDENTIAL-CONSTRUCTION)` to implementing code repositories.
