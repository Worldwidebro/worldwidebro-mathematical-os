...
references:
  - [[CON-011-ELECTRICAL-SERVICES-AGENT-COMMUNICATION]]
  - [[CON-011-ELECTRICAL-SERVICES-FORMATION-CREDENTIAL-TRACKER]]
  - [[SECTOR-REGISTRY]]
---

# Departments & System Ecosystem — Electrical Services
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: CON-011-ELECTRICAL-SERVICES)` to implementing code repositories.
