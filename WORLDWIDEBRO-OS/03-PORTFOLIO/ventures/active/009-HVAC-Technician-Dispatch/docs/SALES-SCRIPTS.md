...
references:
  - [[LT-009-HVAC-Technician-Dispatch-CAPABILITY-STATEMENT]]
  - [[LT-009-HVAC-Technician-Dispatch-FORMATION-CREDENTIAL-TRACKER]]
  - [[LT-009-HVAC-Technician-Dispatch-AGENT-COMMUNICATION]]
  - [[LOOP-FRAMEWORK]]
---
...
> "Hi [Name], this is [Rep Name] with Hvac Technician Dispatch. I'm calling because we work with local carriers and owner-operators running out of the Charlotte region to find higher-paying loads and eliminate empty backhauls. I'm not selling load board subscriptions—we actually run an automated dispatch bot that tracks load rates daily. We put together a list of the 3 highest-paying freight lanes leaving NC this week. Can I text or email that lane list to you?"
...
>
> Best,
> [Rep Name] · Hvac Technician Dispatch
