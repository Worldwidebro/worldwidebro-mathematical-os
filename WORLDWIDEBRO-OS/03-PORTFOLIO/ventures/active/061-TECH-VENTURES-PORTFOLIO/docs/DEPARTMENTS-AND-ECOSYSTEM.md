...
# Departments & System Ecosystem — Tech Ventures Portfolio
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: TECH-061-TECH-VENTURES-PORTFOLIO)` to implementing code repositories.
