...
# Departments & System Ecosystem — Construction Project Management
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: CON-006-CONSTRUCTION-PROJECT-MANAGEMENT)` to implementing code repositories.
