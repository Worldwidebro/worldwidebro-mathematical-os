...
# Departments & System Ecosystem — Green Building Services
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: CON-007-GREEN-BUILDING-SERVICES)` to implementing code repositories.
