...
# Departments & System Ecosystem — Investment Portfolio Ai
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: FIN-023-Investment-Portfolio-AI)` to implementing code repositories.
