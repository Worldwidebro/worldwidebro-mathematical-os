...
# Departments & System Ecosystem — Abandoned Cart Recovery
...
- **Ontology (Neo4j Graph)**: Joins `(Venture: EC-040-Abandoned-Cart-Recovery)` to implementing code repositories.
