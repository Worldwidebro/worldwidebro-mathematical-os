...
CLASSIFICATION_CSV = ROOT / "ventures_classification_final.csv"
...
ENRICHED_JSON = ROOT / "ventures_enriched_option_b.json"
DEPENDENCIES_JSON = ROOT / "ventures_dependencies.json"
...
def build_alignment_json(
    ...
    for v in ventures:
        ...
        matched = [r for r in required if r.lower() in repo_names_lower]
        missing = [r for r in required if r.lower() not in repo_names_lower]
        ...
        record = {
            ...
            "alignment_status": "aligned" if graph_count > 0 and not missing else "needs_attention",
        }
