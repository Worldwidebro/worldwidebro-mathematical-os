...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/acebless/Documents/.claude/.gsd-surface.json`
(sibling to `/Users/acebless/Documents/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/acebless/Documents/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/acebless/Documents/.claude/skills`).
...
`/Users/acebless/Documents/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/acebless/Documents/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/acebless/Documents/.claude/.gsd-surface.json`
Install profile marker: `/Users/acebless/Documents/.claude/.gsd-profile`
Skill dirs: `/Users/acebless/Documents/.claude/skills/gsd-*/`
Engine module: `/Users/acebless/Documents/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/acebless/Documents/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
