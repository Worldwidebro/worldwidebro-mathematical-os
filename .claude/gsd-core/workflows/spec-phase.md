...
ones). Reference: @/Users/acebless/Documents/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/acebless/Documents/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/acebless/Documents/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/acebless/Documents/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/acebless/Documents/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/acebless/Documents/.claude/gsd-core/templates/spec.md.
