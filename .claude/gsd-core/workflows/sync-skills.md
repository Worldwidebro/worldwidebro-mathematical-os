...
INSTALL_JS_GLOBAL="/Users/acebless/Documents/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/acebless/Documents/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
