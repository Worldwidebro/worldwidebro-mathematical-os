...
- **Global scope**: `/Users/acebless/Documents/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/acebless/Documents/.claude/notes/`)
...
2. Glob `/Users/acebless/Documents/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/acebless/Documents/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/acebless/Documents/.claude/notes/` — works in any directory
